...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-liveupdate', __webpack_require__(3));
    Vue.component('detail-liveupdate', __webpack_require__(6));
    Vue.component('form-liveupdate', __webpack_require__(9));
});
